...
SEED=1337
DATA_DIR="/proj/BigLearning/XXXX-3/datasets/imagenet-data"

EXP_NAME=$EXP_PREFIX

mkdir "/proj/BigLearning/XXXX-3/output/imagenet/"
OUTPUT_DIR="/proj/BigLearning/XXXX-3/output/imagenet/"$EXP_NAME
